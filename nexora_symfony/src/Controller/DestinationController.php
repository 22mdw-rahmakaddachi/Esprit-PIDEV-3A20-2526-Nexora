...
class DestinationController extends AbstractController
{
    ...
    public function autocompleteLocation(Request $request, \Symfony\Contracts\HttpClient\HttpClientInterface $httpClient): JsonResponse
    {
        ...
        try {
            ...
            return $this->json(array_values(array_filter($results)), 200, [], ['json_encode_options' => JSON_UNESCAPED_UNICODE]);
        } catch (\Throwable $e) {
    ...
    public function suggestProgramme(Request $request): JsonResponse
    {
        ...
        return $this->json(['programme' => $programme], 200, [], ['json_encode_options' => JSON_UNESCAPED_UNICODE]);
    }
}
